...
namespace WebTimeSheetManagement.Interface
{
    public interface ITimeSheetExport
    {
        ...
        DataSet GetTimeSheetMasterIDTimeSheet(DateTime? FromDate, DateTime? ToDate, int UserID, int AdminID);
        ...
        DataSet GetMonthlyTimeSheetMasterIDTimeSheet(DateTime? FromDate, DateTime? ToDate, int UserID, int AdminID);
    }
}
