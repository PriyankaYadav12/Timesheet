...
namespace WebTimeSheetManagement.Concrete
{
    public class ProjectConcrete : IProject
    {
        ...
        public List<ProjectMaster> GetListofProjectsByRegistrationID(int RegistrationId)
        {
            try
            {
                using (var _context = new DatabaseContext())
                {
                    var listofProjects = (from project in _context.ProjectMaster
                                          join projectmap in _context.UserProjectMapping on project.ProjectID equals projectmap.ProjectID
                                          where projectmap.RegistrationID == RegistrationId
