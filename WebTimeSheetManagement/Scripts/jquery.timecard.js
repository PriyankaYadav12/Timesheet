...
function CalEnd() {
    ...
    for (var i = 0; i < 7; i++) {
        ...
        //else if (i == 6) {
        //    $("#label8").text('[' + weekday[data.getDay()] + ']');
        //    $("#date8").text(tempdate.getDate() + '-' + tempdate.getFullYear());
        //    var hddate8 = data.getFullYear() + '-' + parseFloat(data.getMonth() + 1) + '-' + data.getDate();
        //    $("#hdtext8").val(hddate7);
        //    $("#DaysofWeek8").val(weekday[data.getDay()]);
