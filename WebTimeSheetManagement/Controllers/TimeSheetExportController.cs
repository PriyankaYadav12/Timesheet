...
namespace WebTimeSheetManagement.Controllers
{
    ...
    public class TimeSheetExportController : Controller
    {
        ...
        public ActionResult TimeSheetReport(TimeSheetExportUserModel objtimesheet)
        {
            ...
            DataTable dt = new DataTable();
            var filename = "";
            if (objtimesheet.RegistrationID != 0)
            {
                filename = _ITimeSheetExport.GetUsernamebyRegistrationID(objtimesheet.RegistrationID);
            }
            else
            {
                filename = "All";
            ...
            try
            {
                if(Request.Form["Reporttype"]== "Weekly")
                {
                    ...
                    var timesheetdata = _ITimeSheetExport.GetTimeSheetMasterIDTimeSheet(objtimesheet.FromDate, objtimesheet.ToDate, objtimesheet.RegistrationID, Convert.ToInt32(Session["RegistrationID"]));
                ...
                else
                {
                    ...
                    dt.Columns.Add("Total", typeof(string));
                    dt.Columns.Add("Description", typeof(string));
                    var timesheetdata = _ITimeSheetExport.GetMonthlyTimeSheetMasterIDTimeSheet(objtimesheet.FromDate, objtimesheet.ToDate, objtimesheet.RegistrationID, Convert.ToInt32(Session["RegistrationID"]));
                    if (timesheetdata != null)
                    {
                        if (timesheetdata.Tables.Count < 0)
                        {
